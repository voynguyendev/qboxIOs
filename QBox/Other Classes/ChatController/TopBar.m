    ...
    if (self) {
        if (CGRectEqualToRect(frame, CGRectZero)) {
            if (UIInterfaceOrientationIsPortrait([UIApplication sharedApplication].statusBarOrientation)) {
                ...
                self.frame = CGRectMake(0, 0, ScreenHeight(), 44);
            }
        }
       ...
       // _tintColor = [UIColor colorWithRed:0.142954 green:0.60323 blue:0.862548 alpha:1];
        ...
        topImage.frame=self.bgToolbar.bounds;
        topImage.image=[UIImage imageNamed:@"tabbar"];
       ...
       // _leftBtn.frame = CGRectMake(4, 20, 40, 40);
         _leftBtn.frame = CGRectMake(0, 7, 45, 30);
        ...
        [_leftBtn setImage:[UIImage imageNamed:@"back_blue"] forState:UIControlStateNormal];
        [self addSubview:_leftBtn];
        
        _rightBtn = [UIButton buttonWithType:UIButtonTypeCustom];
        
        _rightBtn.frame = CGRectMake(width(self) - 4, 5, -40, 40);
        ...
        _middleBtn.center = CGPointMake(self.center.x, self.center.y);
        ...
        [_middleBtn setImage:[UIImage imageNamed:@"nav_chat_icon"] forState:UIControlStateNormal];
