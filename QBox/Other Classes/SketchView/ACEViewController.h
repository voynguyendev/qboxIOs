...
@property (nonatomic, unsafe_unretained) IBOutlet UIToolbar *topToolBar;

@property (nonatomic, unsafe_unretained) IBOutlet UIToolbar *bottomToolBar;

@property(assign,nonatomic)int postImageValue;
// actions
