...
@interface ResetPasswordController ()<UITextFieldDelegate,loginDelegate,UIAlertViewDelegate>
{
...
-(void)createLoginUI
{
    ...
    emailTextField.placeholder =@" Enter your password...";
    ...
    nameImg.image=[UIImage imageNamed:@"enterpassword_icon"];
    nameImg.contentMode=UIViewContentModeScaleAspectFit;
    ...
    passwordTextField.placeholder = @"Enter confirm password...";
    ...
    CGFloat textFieldMaxX=CGRectGetMaxX(passwordTextField.frame);
    ...
    [loginButton setImage:[UIImage imageNamed:@"new_btreset.png"] forState:UIControlStateNormal];
    [backgroundScrollview addSubview:loginButton];
    
    //Cancel
    
    UIButton *loginFbBtn = [UIButton buttonWithType:UIButtonTypeCustom] ;
    loginFbBtn.frame = CGRectMake(emailTextField.frame.origin.x, passwordTextField.frame.origin.y+passwordTextField.frame.size.height+10, 120, 30);
    [loginFbBtn setImage:[UIImage imageNamed:@"Resetpassword_Cancel_button_new"] forState:UIControlStateNormal];
...
{
    resetPasswordAlertView=[[UIAlertView alloc]initWithTitle:@"Alert!" message:@"Please enter your email address" delegate:self cancelButtonTitle:@"Cancel" otherButtonTitles:@"OK", nil];
...
-(void)loginClick
{
    ...
    if (validationBool==YES)
    {
        ...
        [WebServiceSingleton sharedMySingleton].loginDelegate=self;
        [[WebServiceSingleton sharedMySingleton]changepassword:email password:emailTextField.text];
        //
    }
...
-(BOOL) validationCheck
{
    ...
    if ([emailTextField.text isEqualToString:@""])
    {
        ...
        UIAlertView *alertView=[[UIAlertView alloc]initWithTitle:@"Alert!!" message:@"Please enter password" delegate:self cancelButtonTitle:nil otherButtonTitles:@"Ok", nil];
        [alertView show];
    ...
    else if (![emailTextField.text isEqualToString:passwordTextField.text])
    {
        UIAlertView *alertView=[[UIAlertView alloc]initWithTitle:@"Alert!!" message:@"Password not match confirm password" delegate:self cancelButtonTitle:nil otherButtonTitles:@"Ok", nil];
        [alertView show];
    }
    else
    {
...
-(void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    ...
    if (alertView==loginAlertView)
    {
        if (buttonIndex==0)
        {
            LoginViewController_iPhone *TabVC=[[LoginViewController_iPhone alloc]init];
