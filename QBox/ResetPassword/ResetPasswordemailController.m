...
@interface ResetPasswordemailController ()<UITextFieldDelegate,loginDelegate,UIAlertViewDelegate>
{
...
@implementation ResetPasswordemailController
...
-(void)createLoginUI
{
    ...
    emailLabel.text=@"E-mail me a link to reset my password ";
...
-(void)loginClick
{
    ...
    if (validationBool==YES)
    {
        ...
        [WebServiceSingleton sharedMySingleton].loginDelegate=self;
        [[WebServiceSingleton sharedMySingleton]sendmail_code:emailTextField.text];
        //
    }
...
-(void)successFullyLogin :(NSArray *)array
{
    ...
    ResetPasswordcodeController *TabVC=[[ResetPasswordcodeController alloc]init];
